...
def shipping_address(self):
    ...
    return redirect(app_reverse(
        'shipping-address', 'leonardo_module_eshop.apps.checkout'))
...
def shipping_method(self):
    from leonardo.module.web.widget.application.reverse import app_reverse
    return redirect(app_reverse('shipping-method', 'leonardo_module_eshop.apps.checkout'))

views.ShippingAddressView.get_success_response = shipping_method
views.ShippingAddressView.get_success_url = lambda o: app_reverse_lazy('shipping-method', 'leonardo_module_eshop.apps.checkout')


def get_success_response(self):
    return redirect(app_reverse_lazy(
        'payment-method', 'leonardo_module_eshop.apps.checkout'))


def payment_detail(self):
    return redirect(app_reverse_lazy(
        'payment-details', 'leonardo_module_eshop.apps.checkout'))

mixins.OrderPlacementMixin.get_success_url = app_reverse_lazy(
    'thank-you', 'leonardo_module_eshop.apps.checkout')
